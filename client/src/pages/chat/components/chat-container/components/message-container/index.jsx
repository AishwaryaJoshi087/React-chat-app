          ...
          >
            {checkIfImage(message.fileUrl) ? (
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <span
                  className="bg-black/20 rounded-full p-2 text-2xl hover:bg-black/30 cursor-pointer transition-all duration-300"
    ...
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full">
      ...
      {showImage && (
        <div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg">
          <div className="flex items-center justify-center w-[40vw] h-[40vh]">
            <img src={`${HOST}/${imageURL}`} />
          </div>
          <div className="flex gap-5 fixed top-0 mt-5 right-5">
            <button
              className="bg-black/20 rounded-full p-2 text-2xl hover:bg-black/30 cursor-pointer transition-all duration-300"
