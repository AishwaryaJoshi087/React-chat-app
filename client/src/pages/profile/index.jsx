          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            ...
            <div className="w-full">
              <Input
                ...
                value={firstName}
                className="rounded-lg p-6 bg-[#2c2e3b] border border-transparent focus:outline-none focus:border-white focus:ring-2 focus:ring-white transition-all duration-300"
              />
            </div>
            <div className="w-full">
              <Input
